// BIP39 English wordlist — 2048 words as specified in BIP-0039.
// This is the standard wordlist used by the bip39 Rust crate for
// mnemonic generation and validation.
export const BIP39_WORDS: string[] = [
  "abandon", "ability", "able", "about", "above", "absent", "absorb", "abstract", "absurd", "abuse",
  "access", "accident", "account", "accuse", "achieve", "acid", "acoustic", "acquire", "across", "act",
  "action", "actor", "actress", "actual", "adapt", "add", "addict", "address", "adjust", "admit",
  "adult", "advance", "advice", "aerobic", "affair", "afford", "afraid", "africa", "age", "agent",
  ...
  "interest", "into", "invest", "invite", "island", "isolate", "issue", "item", "ivory", "jacket",
